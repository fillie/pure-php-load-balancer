...
class RoundRobinLoadBalancerTest extends TestCase
{
    public function testConstructorWithServers(): void
    {
        ...
        $this->assertEquals($servers, $loadBalancer->getServers());
    }
    ...
    public function testConstructorWithoutServers(): void
    {
        ...
        $this->assertEquals([], $loadBalancer->getServers());
    }
    ...
    public function testAddServer(): void
    {
        ...
        $this->assertEquals(['server1'], $loadBalancer->getServers());
        
        $loadBalancer->addServer('server2');
        $this->assertEquals(['server1', 'server2'], $loadBalancer->getServers());
    }
    ...
    public function testRemoveServer(): void
    {
        ...
        $this->assertEquals(['server1', 'server3'], $loadBalancer->getServers());
    }
